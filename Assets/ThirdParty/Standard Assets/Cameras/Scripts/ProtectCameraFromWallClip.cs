...
namespace UnityStandardAssets.Cameras
{
    ...
    {
        public float clipMoveTime = 0.05f;              // spawnDelay taken to move when avoiding cliping (low value = fast, which it should be)
        public float returnTime = 0.4f;                 // spawnDelay taken to move back towards desired position, when not clipping (typically should be a higher value than clipMoveTime)
