...
namespace UnityStandardAssets.Utility
{
    ...
    public class FOVKick
    {
        ...
        public float TimeToIncrease = 1f;               // the amount of spawnDelay the field of view will increase over
        public float TimeToDecrease = 1f;               // the amount of spawnDelay the field of view will take to return to its original size
