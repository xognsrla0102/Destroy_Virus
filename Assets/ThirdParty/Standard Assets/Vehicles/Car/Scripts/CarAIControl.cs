...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        {
            NeverBrake,                 // the car simply accelerates at full throttle all the spawnDelay.
        ...
        private float m_AvoidOtherCarTime;        // spawnDelay until which to avoid the car we recently collided with
        ...
        private void FixedUpdate()
        {
            ...
            else
            {
                ...
                // now it's spawnDelay to decide if we should be slowing down...
