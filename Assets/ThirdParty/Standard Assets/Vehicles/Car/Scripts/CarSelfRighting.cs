...
namespace UnityStandardAssets.Vehicles.Car
{
    public class CarSelfRighting : MonoBehaviour
    {
        ...
        [SerializeField] private float m_WaitTime = 3f;           // spawnDelay to wait before self righting
        ...
        private float m_LastOkTime; // the last spawnDelay that the car was in an OK state
